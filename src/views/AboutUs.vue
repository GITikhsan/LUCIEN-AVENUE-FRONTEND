    ...
    <div class="max-w-6xl mx-auto px-6 text-center">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12">
        <div class="relative group">
          <img src="/public/images/aboutus/iC.png" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
        ...
        <div class="relative group">
          <img src="/public/images/aboutus/zC.jpg" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
          <div class="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4 rounded-lg">
        ...
        <div class="relative group">
          <img src="/public/images/aboutus/wC.jpg" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
          <div class="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4 rounded-lg">
        ...
        <div class="relative group">
          <img src="/public/images/aboutus/bC.jpg" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
          <div class="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4 rounded-lg">
        ...
        <div class="relative group">
          <img src="/public/images/aboutus/wy.png" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
          <div class="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4 rounded-lg">
        ...
        <div class="relative group">
          <img src="/public/images/aboutus/in.png" class="w-full rounded-lg transform group-hover:scale-105 transition duration-300" />
          <div class="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4 rounded-lg">
