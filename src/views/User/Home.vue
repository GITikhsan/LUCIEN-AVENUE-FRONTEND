...
<template>
 ...
 <section class="py-5 text-center">
  ...
  <!-- Banner Men -->
  <section>
        <div class="position-relative w-100 vh-100 bg-cover bg-center d-flex align-items-center justify-content-center text-center text-white"Add commentMore actions
